...
$(function () {
    ...
    function updateCurrentTime() {
        ...
        let hour = d.getHours();
        let hourOffset = hour - $start_time;
        ...
        $("#stages > div:first-child").html(day + "</br>" + print_hour + ":" + print_minute + ":" + print_second + " " + ampm);
        ...
        let leftPx = (dayOffset * $px_day) + ((hourOffset + (minute / 60) + (second / 3600)) * 240)
